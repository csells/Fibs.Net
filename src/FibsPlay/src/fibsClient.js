export class FibsClient {

  session = { status: "closed" }; // status = closed|opened|authenticated
  settings = {};
  who = [];
  watching = {};

  redoublesValues() { return this._getValidRedoublesValues(); }
  timezoneValues() { return this._getValidTimezoneValues(); }

...
public class Invite_Command implements JibsCommand {
    public boolean execute(JibsServer jibsServer, Player player,
        ...
        Player invitee = ClientWorker.getPlayer(jibsServer, args[1]); // invited
                                                                      // player
        ...
        if (invitee != null) {
            ...
            SavedGameParam resumeData = JibsGame.loadGame(jibsServer,
                                                          player.getName(),
                                                          invitee.getName());
            ...
            if (resumeData != null) {
                if (resumeData.getMatchVersion() == JibsMatch.nPointMatch) {
                    ...
                    msg = jibsMessages.convert("m_invite_saved_match_unlimited");
                }

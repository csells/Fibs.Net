...
public class BackgammonBoard {
    ...
    public BackgammonBoard(final BackgammonBoard b2) {
        ...
        this.pDie1.setJibsServer(b2.pDie1.getJibsServer());
        this.pDie2.setJibsServer(b2.pDie2.getJibsServer());
        this.oDie1.setJibsServer(b2.oDie1.getJibsServer());
        this.oDie2.setJibsServer(b2.oDie2.getJibsServer());
        this.pDie1.setValue(b2.pDie1.getValue());
        this.pDie2.setValue(b2.pDie2.getValue());
        this.oDie1.setValue(b2.oDie1.getValue());
        this.oDie2.setValue(b2.oDie2.getValue());
        this.bar = b2.bar;
    ...
    public BackgammonBoard(JibsServer jibsServer, String player1Name,
                           String player2Name, int matchlength,
    ...
    public void init(JibsServer jibsServer, String player1Name,
        ...
        pDie1 = new Die(jibsServer);
        pDie2 = new Die(jibsServer);
        oDie1 = new Die(jibsServer);
        oDie2 = new Die(jibsServer);
        ...
        board[19] = -5;
        /*
         * board[1]=-2; board[3] = 2; board[4] = 2; board[6] = 3; board[8] = 1;
         * board[12] = -4; board[13] = 5; board[17] = -4; board[19] = -5;
         * board[24] = 2; //board[0]=2; // Bar von 'X' //board[25]=2; // Bar von
         * 'O'
         */
        forcedMove = 0;
        didCrawford = 0;
    ...
    public String getOutputBoard(JibsGame game) {
        ...
        strBoard.append(":");
        strBoard.append(getpDie1().getValue());
        strBoard.append(":");
        strBoard.append(getpDie2().getValue());
        strBoard.append(":");
        strBoard.append(getoDie1().getValue());
        strBoard.append(":");
        strBoard.append(getoDie2().getValue());
        strBoard.append(":");
     ...
     * @param k
     */
    public void outBoard(JibsWriter out1, String name, int i, int dice1,
        ...
        case 1:default:
        case 2:
            outBoard_2(out1, i, dice1, dice2, j, k);

            break;

        case 3:

            String x = outBoard_3(out1, name, i, dice1, dice2, j, k);
            out1.println(x);
     ...
     * @param dice22
     */
    public void outBoard_2(JibsWriter out1, int turn, int dice11, int dice12,
     ...
     * @return
     */
    public String outBoard_3(JibsWriter out1, String name, int turn,
                             int dice11, int dice12, int dice21, int dice22) {
        StringBuffer strBoard = new StringBuffer();
     ...
     * @param d1
     */
    public void setpDie1(Die d1) {
        pDie1.setValue(d1.getValue());
    }
     ...
     * @param d2
     */
    public void setpDie2(Die d2) {
        pDie2.setValue(d2.getValue());
    }
    ...
    public BackgammonBoard switch2O() {
        ...
        opBoard.setColor(1);
        opBoard.getpDie1().setValue(getoDie1().getValue());
        opBoard.getpDie2().setValue(getoDie2().getValue());
        opBoard.getoDie1().setValue(getpDie1().getValue());
        opBoard.getoDie2().setValue(getpDie2().getValue());
